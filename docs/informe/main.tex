...
\vspace{0.3cm}
{\large \textbf{CASTRO ESPINOZA KEVIN MOISES}}\par
{\large \textbf{ESCUDERO PLAZA MARIA DEL ROSARIO}}\par
{\large \textbf{TEJADA BAJAÑA LUIS ALEJANDRO}}\par

\vspace{0.3cm}
{\large \textbf{DOCENTE:}}\par
\vspace{0.3cm}
{\large \textbf{DR. GLEISTON CICERÓN GUERRERO ULLOA, PH.D.}}\par

\vspace{0.3cm}
{\large \textbf{CURSO:}}\par
\vspace{0.3cm}
{\large \textbf{5TO SOFTWARE}}\par

\vspace{0.3cm}
{\large \textbf{FECHA:}}\par
\vspace{0.3cm}
{\large \textbf{VIERNES, 24 DE JULIO DEL 2026}}\par

\vspace{0.3cm}
{\large \textbf{COMMIT HEAD:}}\par
\vspace{0.3cm}
{\large \texttt{1cd8851}}\par

\vspace{0.3cm}
{\large \textbf{DOI:}}\par
\vspace{0.3cm}
{\large \texttt{10.5281/zenodo.XXXXXXX}}\par
